...
RSpec.describe "As a User" do
  ...
  it "sees a viewing parties section" do
    visit '/dashboard'
    within "#movie-parties-#{@user.id}" do
  ...
  it "sees viewing parties invited to", :vcr do
    ...
    @party1 = MovieParty.create!(movie_id: @movie.id, movie_title: @movie.title, runtime: @movie.runtime, date: "10/13/2020", time: "4:00", user: @user)
    PartyGuest.create(movie_party_id: @party1.id, guest_id: @hank.id)
    @party2 = MovieParty.create!(movie_id: @movie.id, movie_title: @movie.title, runtime: @movie.runtime, date: "10/13/2020", time: "4:00", user: @hank)
    PartyGuest.create(movie_party_id: @party2.id, guest_id: @user.id)
    @invited = @user.parties_invited_to
    visit '/dashboard'
    within "#movie-parties-#{@user.id}" do
